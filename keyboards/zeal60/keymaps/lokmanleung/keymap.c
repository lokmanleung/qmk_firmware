...
// Default layer
     ...
     * |-------------------------------------------------------------|
     * |Ctrl |Win |Alt |         Space         |Alt |Ctrl |Fn1 |Fn2  |
     * '-------------------------------------------------------------'
     */
[0] = {
	...
	{KC_LCTL, KC_LGUI, KC_LALT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_SPC,  KC_NO,   KC_NO,   KC_RALT, KC_RCTL, FN_MO13, FN_MO23}
},
...
// Fn1 Layer
     ...
     * |      |   |Up |   |   |   |   |   |   |   |   |   |   |      |
     * |-------------------------------------------------------------|
     * |CapsLk |Lft|Dwn|Rht|F  |G  |H  |J  |K  |L  |;  |'  |Enter    |
     * |-------------------------------------------------------------|
     * |Shift   |Z  |X  |C  |V  |B  |N  |M  |,  |.  |/  |Shift  |`   |
     * |-------------------------------------------------------------|
